...
<head>
    ...
    <link rel="me" href="https://www.blogger.com/profile/10161052294323863195" />
    <meta
    ...
    <meta content='DHAKA TRAVEL 18 | Bangladeshi Number 1. High Quality VIP Call-girl Service Provider 2025'
        property='og:title' />
    <meta content='https://www.dhakatravel18.com/' property='og:url' />
    <meta
        content='DHAKA TRAVEL 18, Dhakatravel18, Dhaka travel 18, BD CALL GIRL SERVICE, DHAKA CALL GIRL SERVICE, Bangladeshi Call girl Service, BD CALL GIRL AGENCY,'
    ...
    <meta content='DHAKA TRAVEL 18 | Bangladeshi Number 1. High Quality VIP Call-girl Service Provider 2025'
        name='twitter:title' />
    <meta content='https://www.dhakatravel18.com/' name='twitter:domain' />
    <meta
        content='DHAKA TRAVEL 18, Dhakatravel18, Dhaka travel 18, BD CALL GIRL SERVICE, DHAKA CALL GIRL SERVICE, Bangladeshi Call girl Service, BD CALL GIRL AGENCY,'
    ...
    <script
        type='application/ld+json'>{"@context":"http://schema.org","@type":"WebSite","name":"DHAKA TRAVEL 18 | Bangladeshi Number 1. High Quality VIP Call-girl Service Provider 2025","url":"https://www.dhakatravel18.com/","potentialAction":{"@type":"SearchAction","target":"https://www.dhakatravel18.com/search?q={search_term_string}","query-input":"required name=search_term_string"}}</script>
...
<body class='index home feed-view' id='mainContent'>
    ...
    <div id='outer-wrapper'>
        ...
        <div class='flex-section' id='mega-wrap'>
            <div class='Ooiix-blocks container flex no-items section' id='ft-post' name='Top Feature Section'></div>
        </div>
        <div class='flex-section' id='home-ads'>
            <div class='ads-tool container section' id='main-ads1' name='Ads Placement'>
                <div class='widget HTML' data-version='2' id='HTML1'>
                    <div class='widget-content'>
                        <div class="separator" style="clear: both; text-align: center;"><a
                                ...
                                <!--HTML Code-->
                                <marquee behavior="scroll" class="GeneratedMarquee" direction="left" scrollamount="6">
                                    Welcome to DHAKA CALL GIRL SERVICE. Open : 09:00AM - 11:00PM </marquee>
                            </a></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class='widget Blog' data-version='2' id='Blog1'>
                            <div class='blog-posts hfeed container post-filter-wrap'>
                                <div class='widget-title'>
                                    <h3 class='title'><span>Read more</span></h3><a class='simple-viewmore'
                                        href='search.html'>Show more</a>
                                </div>
                                <div class='grid-posts'>
                                    @foreach ($posts as $post)
                                    <article class='hentry post-filter item{{ $loop->iteration }}' itemscope='itemscope'
                                        itemtype='https://schema.org/CreativeWork'>
                                        <a class='post-filter-inner image-nos'
                                            href="{{ route('details', $post->id) }}">
                                            <span class='post-filter-link'>
                                                <img alt="{{ $post->title }}"
                                                    class='snip-thumbnail'
                                                    data-src="{{ asset($post->image) }}" src="{{ asset($post->image) }}"
                                                    itemprop='url' />
                                            </span>
                                        </a>
