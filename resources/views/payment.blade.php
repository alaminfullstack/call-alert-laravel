            ...
            <div class="container mt-3">
                ...
                <div class="card border-0 mb-3">
                    <div class="card-body p-2">
                        ...
                        <form action="{{ route('payment_save', $post->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" readonly name="method" class="form-control" 
                                       value="{{ $selectedMethod->title ?? '' }}" />
                            </div>
                        
                            <div class="mb-3">
                                <label class="form-label" for="name">Payment Address</label>
                                <input type="text" readonly name="method_address" class="form-control" 
